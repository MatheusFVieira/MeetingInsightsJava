...
public class AnaliseResponse {
    ...
    public String getRaciocinio() {
        return raciocinio;
    }

    public void setRaciocinio(String raciocinio) {
        this.raciocinio = raciocinio;
    }

    public NivelRisco getRiscoChurn() {
        return riscoChurn;
    }

    public void setRiscoChurn(NivelRisco riscoChurn) {
        this.riscoChurn = riscoChurn;
    }

    public TipoOportunidade getOportunidadeUpsell() {
        return oportunidadeUpsell;
    }

    public void setOportunidadeUpsell(TipoOportunidade oportunidadeUpsell) {
        this.oportunidadeUpsell = oportunidadeUpsell;
    }

    public String getProdutoRecomendado() {
        return produtoRecomendado;
    }

    public void setProdutoRecomendado(String produtoRecomendado) {
        this.produtoRecomendado = produtoRecomendado;
    }

    public Sentimento getSentimentoGeral() {
        return sentimentoGeral;
    }

    public void setSentimentoGeral(Sentimento sentimentoGeral) {
