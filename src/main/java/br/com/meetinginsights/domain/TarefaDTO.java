...
public class TarefaDTO {
    ...
    public String getAmeacaChurn() {
        return ameacaChurn;
    }

    public void setAmeacaChurn(String ameacaChurn) {
        this.ameacaChurn = ameacaChurn;
    }

    public String getOportunidadeUpsell() {
        return oportunidadeUpsell;
    }

    public void setOportunidadeUpsell(String oportunidadeUpsell) {
        this.oportunidadeUpsell = oportunidadeUpsell;
    }
